...
![OpenAI Voice Terminal Architecture](./images/openai-voice-terminal-architecture-ja.png)
...
このリポジトリのライセンス情報は現在整備中です。明示的な `LICENSE` ファイルを追加するまでは、利用前にリポジトリ管理者の方針を確認してください。
